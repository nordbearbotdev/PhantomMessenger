...
D_CONFIRM_DELETE_MESSAGE = \
    u"Êtes-vous sûr de vouloir supprimer le contact?\n(%s %s)"

# warning about log

D_LOG_WARNING_TITLE = u'TorChat: Archivage est actif'
D_LOG_WARNING_MESSAGE = \
    u"""L'archivage au fichier est activé!!
...
DEC_MSG_ONLY_ALPANUM = \
    u"L'adresse doit seulement contenir des nombres et des lettres minuscule."
...
NOTICE_DELAYED_MSG_WAITING = \
    u"messages retardés attendant pour être envoyé"
