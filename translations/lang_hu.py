...
D_LOG_WARNING_MESSAGE = \
    u"""Logolás mentése fájlba bekapcsolva!
...
D_WARN_USED_PORT_MESSAGE = \
    u"Valószínűleg már egy másik TorChat fut itt:  %s:%s. Csinálj egy másik profilt más porttal, hogy el tudj indítani egy másik TorChat-et!"

# warnig about unread messages

D_WARN_UNREAD_TITLE = u"TorChat: Olvasatlan üzenet"
D_WARN_UNREAD_MESSAGE = \
    u"""Olvasatlan üzeneted van.
...
D_WARN_BUDDY_OFFLINE_MESSAGE = \
    u"Ezt a műveleted nem lehet végrehajtani kapcsolat nélküli partnerrel"

# warning about multiple files

D_WARN_FILE_ONLY_ONE_TITLE = u"TorChat: Sok fájl"
D_WARN_FILE_ONLY_ONE_MESSAGE = \
    u"Nem tudsz egyszerre több fájlt küldeni. Küldd el a fájlokat egyenként, vagy használj tömörítést (pl. zip)"
...
D_WARN_FILE_SAVE_ERROR_MESSAGE = \
    u"""A '%s' fájl létrehozása sikertelen.
...
DEC_MSG_16_CHARACTERS = \
    u"Az azonosító 16 karakter hosszú lehet, nem %i."
DEC_MSG_ONLY_ALPANUM = \
    u"Az azonosító csak számokat és az angol abc betüit tartalmazhatja"
...
DSET_GUI_FLASH_WINDOW = \
    u"Ablak címének villogtatása új üzenet érkezésekor"
DSET_MISC_TITLE = u'Egyebek'
DSET_MISC_TEMP_IN_DATA = \
    u"Ideiglenes fájlok tárolása a saját könyvtárban"
DSET_MISC_TEMP_CUSTOM_DIR = \
    u"Ideiglenes könyvtár (ha üres, akkor az op.rendszer alapértelmezett könyvtára)"
