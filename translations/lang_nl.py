...
D_CONFIRM_DELETE_MESSAGE = \
    u'Weet u zeker dat u deze contactpersoon wilt verwijderen?\n(%s %s)'

# warning about log

D_LOG_WARNING_TITLE = u'TorChat: Logboek ingeschakeld'
D_LOG_WARNING_MESSAGE = \
    u'''Logging naar bestand is geactiveerd!
...
DEC_MSG_16_CHARACTERS = \
    u'Het adres dient 16 karakters lang te zijn, niet %i.'
DEC_MSG_ONLY_ALPANUM = \
    u'Het adres kan alleen cijfers en kleine letters bevatten.'
...
NOTICE_DELAYED_MSG_WAITING = \
    u'vertraagde berichten, wachtend om verzonden te worden'
