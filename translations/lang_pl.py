...
D_LOG_WARNING_MESSAGE = \
    u"""Rejestracja została aktywowana!
...
D_WARN_UNREAD_MESSAGE = \
    u"""Częśc wiadomości została nieprzeczytana.
...
D_WARN_BUDDY_OFFLINE_TITLE = \
    u"TorChat: Kontakt znajduje się poza siecią"
D_WARN_BUDDY_OFFLINE_MESSAGE = \
    u"Nie można wykonac tej operacji z kontaktami pozostającymi poza siecią"

# warning about multiple files

D_WARN_FILE_ONLY_ONE_TITLE = u"TorChat: Kilka plików"
D_WARN_FILE_ONLY_ONE_MESSAGE = \
    u"Nie można wysłac kilku plików podczas jednej operacji. Wyślij każdy osobno lub użyj archiwum ZIP/RAR/7Z."
...
DSET_MISC_TEMP_IN_DATA = \
    u'Przechowuj pliki tymczasowe w katalogu danych'
DSET_MISC_TEMP_CUSTOM_DIR = \
    u"Tymczasowy katalog danych (zostaw puste dla domyślnego systemu operacyjnego)"
